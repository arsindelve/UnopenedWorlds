...
export const collectionPhotography: Record<string, CollectionPhotography> = {
  ...
  planetfall: {
    ...
    photos: [
      ...
      { id: 'will', label: 'Will', src: '/collection/planetfall-will.jpg', caption: 'The Emergency Last Will and Testament — Infocom’s joke, printed on the reverse of the map', role: 'map' },
      { id: 'will-inside', label: 'Will, inside', src: '/collection/planetfall-will-inside.jpg', caption: 'The Emergency Last Will and Testament, opened', role: 'map' },
      { id: 'disk', label: 'The disk', src: '/collection/planetfall-disk.jpg', caption: 'The Planetfall disk, in its Infocom sleeve', role: 'feelies' },
      ...
      { id: 'diary-cover', label: 'Diary', src: '/collection/planetfall-diary-cover.jpg', caption: 'The personal diary — Stellar Patrol of the Third Galactic Union', role: 'feelies' },
      { id: 'diary-1', label: 'Diary, 1', src: '/collection/planetfall-diary-1.jpg', caption: 'The personal diary, in an ensign’s handwriting', role: 'feelies' },
      { id: 'diary-2', label: 'Diary, 2', src: '/collection/planetfall-diary-2.jpg', caption: 'The personal diary, in an ensign’s handwriting', role: 'feelies' },
      { id: 'diary-3', label: 'Diary, 3', src: '/collection/planetfall-diary-3.jpg', caption: 'The personal diary, in an ensign’s handwriting', role: 'feelies' },
      { id: 'diary-4', label: 'Diary, 4', src: '/collection/planetfall-diary-4.jpg', caption: 'The personal diary, in an ensign’s handwriting', role: 'feelies' },
      { id: 'diary-5', label: 'Diary, 5', src: '/collection/planetfall-diary-5.jpg', caption: 'The personal diary, in an ensign’s handwriting', role: 'feelies' },
    ...
    note: 'Twenty-eight photographs, and very nearly the whole package. The sealed IBM PC grey box front and back; the 1983 folio edition that preceded it; the Solid Gold reissue for the Apple II; the folio manual across five of its pages; the InvisiClues map of Complex One and Complex Two; and the feelies themselves—the disk in its sleeve, the Special Assignment Task Force I.D. card issued to an Ensign 7th Class, the personal diary in an ensign’s handwriting, and postcards from Ramos II, Nebulon and Accardia. The map carries Infocom’s own joke on its reverse: an Emergency Last Will and Testament, which solemnly warns that the document is definitely not to be used for drawing a map of unauthorized terrain following successful Planetfall. The grey box shows a heavy shrink-wrap sheen across the poster and, on its back, the 55 Wheeler Street address Infocom used before it moved to CambridgePark Drive.',
  },
  'hollywood-hijinx': {

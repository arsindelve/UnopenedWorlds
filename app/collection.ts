...
export const collectionPhotography: Record<string, CollectionPhotography> = {
  ...
  planetfall: {
    ...
    photos: [
      ...
      { id: 'will', label: 'Will', src: '/collection/planetfall-will.jpg', caption: 'The Emergency Last Will and Testament, from the package' },
      ...
      { id: 'map-drawn', label: 'Hand-drawn map', src: '/collection/planetfall-map-drawn.jpg', caption: 'A hand-drawn map of Complex One and Complex Two, on the back of the will' },
    ...
    note: 'Thirteen photographs. The sealed IBM PC grey box front and back; the 1983 folio edition that preceded it; the Solid Gold reissue for the Apple II; and the feelies themselves—Today’s Stellar Patrol, the Emergency Last Will and Testament inside and out, and postcards from Ramos II and Nebulon. The grey box carries a heavy shrink-wrap sheen across the poster and, on its back, the 55 Wheeler Street address Infocom used before it moved to CambridgePark Drive. The will states that it is definitely not to be used for drawing a map of unauthorized terrain following successful Planetfall; someone drew Complex One and Complex Two on the back of it anyway. Historical materials remain with the preservation projects that made them available.',
  },
  'hollywood-hijinx': {
